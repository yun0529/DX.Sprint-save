...
//            Log.d("shin", "${phone}")
            ...
            else if (pw != binding.signupPw2.text.toString()) {
            ...
            if (phone.length != 13 || phone2[0].length != 3 || phone2[1].length != 4 || phone2[2].length != 4) {
                ...
                Toast.makeText(this, "개인정보보 수집 및 이용에 동의해주세요.", Toast.LENGTH_SHORT).show()
            }else if(!binding.appCheckBox.isChecked){
...
//            showLoadingDialog(context)
        ...
        binding.checkContent.setOnClickListener {
            val intent = Intent(this,SignUpCheckContentActivity::class.java)
            startActivity(intent)
        }
        binding.appCheckContent.setOnClickListener {
            val intent = Intent(this,AppCheckContentActivity::class.java)
            startActivity(intent)
        }
    }
