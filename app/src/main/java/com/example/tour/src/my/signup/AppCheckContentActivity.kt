...
import com.example.tour.databinding.ActivityAppChechContentBinding

class AppCheckContentActivity : BaseActivity<ActivityAppChechContentBinding>(ActivityAppChechContentBinding::inflate) {
    @SuppressLint("SetTextI18n")
    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)

        binding.appCheckContent.text = "제1장 총칙\n" +
                "제1조 (목적) 이 약관은 팀 \"울려라\"가 운영하는 팡파레 “애플리케이션”(이하 “애플리케이션”을 “APP”이라고 합니다)의 서비스 이용 및 제공에 관한 제반 사항의 규정을 목적으로 합니다.\n" +
                "제2조 (용어의 정의) ① 이 약관에서 사용하는 용어의 정의는 다음과 같습니다.\n" +
                "1. “서비스”라 함은 구현되는 PC, 모바일 기기를 통하여 “이용자”가 이용할 수 있는 축제조회서비스 등 회사가 제공하는 제반 서비스를 의미합니다.\n" +
                ...
                "4. “크루”란 “APP”이 제공하는 모임 서비스를 말합니다.\n" +
                ...
                "제10조 (서비스의 이용) ① “APP”은 다음과 같은 서비스를 회원에게 제공합니다. 단, 회사가“APP”으로 제공하는 서비스 이용을 위해 필요시 이용자에게 위치정보이용약관 및 “계정정보”의 제공에 관한 동의를 추가로 요구할 수 있으며, 동의하지 않을 경우 지도 위치 조회 등 일부 서비스가 제한될 수 있습니다.\n" +
                "1. 공공데이터 api를 이용한 부산 축제조회\n" +
                "2. 크루 만들기\n" +
                "3. 크루 참여하기\n" +
                "4. 크루원과의 채팅서비스\n" +
                "5. 기타 회사가 정하는 서비스\n" +
                ...
                "④ 회사는 “APP” 시스템 등의 보수, 점검, 교체, 시스템의 고장, 통신의 두절, 기타 불가항력적 사유가 발생한 경우에는 서비스의 제공을 일시적으로 중단할 수 있습니다. 다만, 서비스 중단의 경우 회사는 “APP”에 사전 통지하고, 사전에 통지할 수 없는 부득이한 사유가 있는 경우 전화번호 또는 이메일로 회원에게 통지합니다.\n" +
